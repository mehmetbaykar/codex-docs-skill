        ...
        <tfoot>
          <tr>
            <td colspan="4" style="text-align:center">
              ...
              See [Speed](https://developers.openai.com/codex/speed) for rates.
            </td>
          </tr>
          <tr>
            <td colspan="4" style="text-align:center">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align:center">1 image (1024px × 1024px)</td>
            <td colspan="4" style="text-align:center">
              \~5-6 credits
            </td>
          </tr>
          <tr>
            <td>Image generation</td>
            <td style="text-align:center">1 image (1024px × 1536px)</td>
            <td colspan="4" style="text-align:center">
              \~7-8 credits
            </td>
          </tr>
